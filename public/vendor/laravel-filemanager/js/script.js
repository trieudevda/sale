...
function displayErrorResponse(jqXHR) {
  ...
  try {
    ...
    // responseText was not JSON (e.g. HTML error page or debug output)
    // fall back to raw text or status text so the user can see something
    message = jqXHR.responseText || jqXHR.statusText;
    // strip potential <script> tags to prevent injection into notify
